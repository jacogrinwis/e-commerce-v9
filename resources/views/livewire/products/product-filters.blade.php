<div class="space-y-6">
    <div>
        <h2 class="mb-1">
            <span class="text-lg font-semibold">Categories ({{ $categoriesCount }})</span>
    ...
    <div>
        <h2 class="mb-1">
            <span class="text-lg font-semibold">Colors ({{ $colorsCount }})</span>
    ...
    <div>
        <h2 class="mb-1">
            <span class="text-lg font-semibold">Materials ({{ $materialsCount }})</span>
    ...
    <div>
        <h2 class="mb-1">
            <span class="text-lg font-semibold">Beschikbaarheid <!--({{ $stockStatusesCount }})--></span>
    ...
    <div>
        <h2 class="mb-1">
            <span class="text-lg font-semibold">Tags ({{ $tagsCount }})</span>
